    ...
    return (
        <div className="break-work 2xl:w-[760px] xl:w-[500px] md:w-[300px]  font-sans text-neutral-900 ">
            ...
            <div className="mt-10">
                ...
                <div className="font-sans text-sm mt-4 text-neutral-900 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-2 gap-4">
                    {/**/}
                    <div className="flex gap-2 mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
                             stroke="currentColor" className="w-6 h-6 text-blue-indigo">
                            <path strokeLinecap="round" strokeLinejoin="round"
                                  d="m15.75 10.5 4.72-4.72a.75.75 0 0 1 1.28.53v11.38a.75.75 0 0 1-1.28.53l-4.72-4.72M4.5 18.75h9a2.25 2.25 0 0 0 2.25-2.25v-9a2.25 2.25 0 0 0-2.25-2.25h-9A2.25 2.25 0 0 0 2.25 7.5v9a2.25 2.25 0 0 0 2.25 2.25Z"/>
                        </svg>
                        <span className="">14 hours on-demand video</span>
                    </div>
                    {/**/}
                    <div className="flex gap-2 mb-4">
                        ...
                        <span className="">Native teacher</span>
                    </div>
                    {/**/}
                    <div className="flex gap-2 mb-4">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        ...
                        <span className="">100% free document</span>
                    </div>
