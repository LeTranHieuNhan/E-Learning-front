        ...
        <div>
            ...
            <div className="grid grid-cols-10 gap-4 mt-4">
                <div className="col-span-7 h-full">
                    <ReactPlayer
                        url={video} // Specify the YouTube video URL
                ...
                <div className="col-span-3 p-4 ">
                    <div className="flex justify-between">
                        ...
                        <span className="font-bold font-sans text-sm"> 3 <span className='font-normal'>/12 Completed  </span> </span>
                    </div>

                    <div className='flex justify-between mt-7  font-sora cursor-pointer py-4 px-2 '>
                        <h2 className='text-sm text-[#9095A0FF]'>01. Consectetur adipiscing elit</h2>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-5 h-5 text-[#2ACCCFFF]">
                    ...
                    <div className='flex justify-between mt-3  font-sora cursor-pointer py-4 px-2'>
                        <h2 className='text-sm text-[#9095A0FF]'>02. Consectetur adipiscing elit</h2>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-5 h-5 text-[#2ACCCFFF]">
                            <path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5" />
                        </svg>
                    ...
                    <div className='flex justify-between mt-3  font-sora cursor-pointer py-4 px-2'>
                        <h2 className='text-sm text-[#9095A0FF]'>03. Consectetur adipiscing elit</h2>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-5 h-5 text-[#2ACCCFFF]">
                            <path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5" />
                        </svg>

                    </div>
                    <div className='flex justify-between mt-3  font-sora cursor-pointer bg-[#FFF4F0FF] text-[#F84B01FF] py-4 px-2 rounded'>
                        <h2 className='text-sm text-[#F84B01FF]'>04. Consectetur adipiscing elit</h2>
