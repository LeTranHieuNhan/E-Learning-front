        ...
        <Link to={`/course/${course.id}`} onClick={handleClick}>
            <div className="shadow-black border lg:w-48 xl:w-64 cursor-pointer">
                <img
                    ...
                    src={course?.images[0] || "https://plus.unsplash.com/premium_photo-1663933534267-fe6969cd26e1?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxlZGl0b3JpYWwtZmVlZHwxfHx8ZW58MHx8fHx8"}
                    alt="Course Image"
                />
                <div className="mt-4 px-2 py-2">
                    ...
                    <div className="flex mt-4 justify-between">
                        <div className="flex">
                            ...
                            <span className="text-sm font-bold font-sans">{course.averageRating == 0 || 3 ? 3 : course.averageRating}</span>
                            <span className="ml-2 text-sm text-gray-400 font-sans">({course.totalReviews})</span>
                        </div>
