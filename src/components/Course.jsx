            ...
            <div className="shadow-black border lg:w-48 xl:w-64 cursor-pointer">
                ...
                <div className="mt-4 px-2 py-2">
                    <div className="flex justify-between">
                        ...
                        {/* eslint-disable-next-line react/prop-types */}
                        <span className="rounded-full bg-tertiary3-500 font-sans text-white leading-4 text-sm h-6 py-1 px-4">{course.level}</span>
                    </div>
                    {/* eslint-disable-next-line react/prop-types */}
                    ...
                    <div className="flex mt-4 justify-between">
                        <div className="flex">
                            ...
                            {/* eslint-disable-next-line react/prop-types */}
                            <span className="text-sm font-bold font-sans">{course.rating}</span>
