      ...
      <div className="grid grid-cols-3 gap-4 divide-x">
        <div className="col-span-2">
          <div className="mt-[32px] ml-[155px]">
            ...
            <div className="shadow-black border rounded-md w-[700px] h-[168px] mt-[45px] bg-[#F8F9FAFF]">
              <div className="mt-[24px] ml-[24px] ">
                <h1 className="text-[#171A1FFF] text-[24px] leading-[36px] font-sans font-bold">
                  J2YB Class
                </h1>
                <h1 className="mt-[4px] text-[#171A1FFF] text-[14px] leading-[22px] font-sans font-normal">
                  Dao Vo
                </h1>
                <svg
                ...
                <button class="ml-[34px] shadow-lg mt-[3px] bg-[#FFFFFFFF] hover:bg-gray-400 text-[#DE3B40FF] font-bold py-2 px-4 rounded inline-flex items-center w-[118px] h-[30px]">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                  ...
                  <span className="text-[12px] leading-[20px] font-sans font-bold">
                    Out this class
                  </span>
                </button>
              </div>
            ...
            <div className="shadow-black border rounded-md w-[700px] h-[168px] mt-[32px] bg-[#FFF4F0FF]">
              <div className="mt-[24px] ml-[24px] ">
                <h1 className="text-[#171A1FFF] text-[24px] leading-[36px] font-sans font-bold">
                  AI Class
                </h1>
        ...
        <div className="col-span-1">
          <div className="grid grid-cols-1 divide-y">
            <div className="ml-[40px] mt-[30px]">
              <img
                class="h-[120px] w-[120px] rounded-full border-4 border-white dark:border-gray-800 "
              ...
              <button className="mt-[32px] bg-[#6E75D1FF] text-white rounded-[18px] justify-center h-[36px] w-[150px] items-center flex gap-2 text-[14px] leading-[22px] font-sans font-normal">
                Draft an article
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
            ...
            <div className="ml-[40px]">
              ...
              <div className="flex mt-[46px] items-center">
                <img
                  class=" h-[32px] w-[32px] rounded-2xl border-4 border-white dark:border-gray-800 "
                  src="https://randomuser.me/api/portraits/women/21.jpg"
                  alt=""
                ></img>
            ...
            <div className="ml-[40px]">
              ...
              <div className="mt-[32px] flex gap-[12px]">
                <button className="rounded-3xl bg-[#F3F4F6FF] w-[170px] h-[44px] items-center justify-between text-[#323842FF] text-[16px] leading-[26px] font-sans font-normal ">
                  Computer Science
                </button>
                <button className="rounded-3xl bg-[#F3F4F6FF] w-[56px] h-[44px] items-center justify-between text-[#323842FF] text-[16px] leading-[26px] font-sans font-normal ">
                  Art
                </button>
              </div>
              <div className="mt-[12px] flex gap-[12px]">
                <button className="rounded-3xl bg-[#F3F4F6FF] w-[123px] h-[44px] items-center justify-between text-[#323842FF] text-[16px] leading-[26px] font-sans font-normal ">
                  Blockbuster
                </button>
                <button className="rounded-3xl bg-[#F3F4F6FF] w-[120px] h-[44px] items-center justify-between text-[#323842FF] text-[16px] leading-[26px] font-sans font-normal ">
                  Technology
                </button>
              </div>
              <div className="mt-[12px] flex gap-[12px]">
                <button className="rounded-3xl bg-[#F3F4F6FF] w-[144px] h-[44px] items-center justify-between text-[#323842FF] text-[16px] leading-[26px] font-sans font-normal ">
                  Family Therary
                </button>
                <button className="rounded-3xl bg-[#F3F4F6FF] w-[83px] h-[44px] items-center justify-between text-[#323842FF] text-[16px] leading-[26px] font-sans font-normal ">
                  Career
                </button>
              </div>
              <div className="mt-[12px] flex gap-[12px]">
                <button className="rounded-3xl bg-[#F3F4F6FF] w-[119px] h-[44px] items-center justify-between text-[#323842FF] text-[16px] leading-[26px] font-sans font-normal ">
                  Writing tips
                </button>
              </div>
